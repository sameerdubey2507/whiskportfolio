    ...
    <section className="relative z-20 bg-[#0a0a0a] py-32 px-4 md:px-12 overflow-hidden" id="contact">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <div className="flex flex-col gap-6 mb-12">
              <a href="mailto:craftedlegend25@gmail.com" className="flex items-center gap-4 text-gray-300 hover:text-white transition-colors group">
                ...
                <span className="text-lg">craftedlegend25@gmail.com</span>
              </a>
              
              <div className="flex items-center gap-4">
                 <SocialLink href="https://github.com/sameerdubey2507" icon={<GithubIcon />} label="GitHub" />
                 <SocialLink href="https://linkedin.com/in/sameerdubey2507" icon={<LinkedinIcon />} label="LinkedIn" />
                 <SocialLink href="https://twitter.com/sameerdubey2507" icon={<TwitterIcon />} label="Twitter" />
              </div>
            </div>
        ...
        <footer className="mt-24 pt-8 border-t border-white/5 text-center text-gray-500 font-mono text-sm">
           <p>&copy; {new Date().getFullYear()} Sameer Dubey. All rights reserved.</p>
        </footer>
      </div>
    </section>
  );
