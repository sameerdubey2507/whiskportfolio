...
const projects = [
  {
    id: "pagani",
    title: "Pagani Showcase",
    category: "3D Web",
    description: "Where hyper-car engineering meets the modern web. A visual exploration of Pagani's design language.",
    longDescription: "This project is a visual exploration of Pagani's design language, wrapped in a cyber-neon, glassmorphic UI. By leveraging 3D web technologies, the user experiences an immersive showcase of hyper-car engineering.",
    techStack: ["Next.js", "React", "TypeScript", "3D Web"],
    repo: "https://github.com/sameerdubey2507/pagani",
    demo: "#",
    color: "from-blue-600/20 to-cyan-500/20",
    hoverColor: "group-hover:from-blue-600/40 group-hover:to-cyan-500/40",
    span: "md:col-span-2 md:row-span-2",
    mediaType: "image",
    mediaUrl: "https://images.pexels.com/photos/337909/pexels-photo-337909.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    demoUrl: "https://images.pexels.com/photos/120049/pexels-photo-120049.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
  },
  {
    id: "ironman",
    title: "Iron Man UI",
    category: "Landing Page",
    description: "An Iron Man-themed landing page UI for a freelancing platform.",
    longDescription: "Built for design inspiration, this Iron Man-themed landing page UI provides a high-fidelity aesthetic for a freelancing platform.",
    techStack: ["TypeScript", "React", "Tailwind CSS"],
    repo: "https://github.com/sameerdubey2507/ironman",
    demo: "#",
    color: "from-red-600/20 to-orange-500/20",
    hoverColor: "group-hover:from-red-600/40 group-hover:to-orange-500/40",
  ...
  },
  {
    ...
    title: "SameerHub",
    category: "E-Commerce",
    description: "A high-performance, visually engaging e-commerce UI inspired by Nike.",
    longDescription: "Focused on modern design, product presentation, and fluid user experience. This project serves as an immersive e-commerce mock platform.",
    techStack: ["JavaScript", "React", "Tailwind CSS"],
    repo: "https://github.com/sameerdubey2507/sameerhub",
    demo: "#",
  ...
  },
  {
    ...
    description: "A production-grade RL environment simulating India's 108/112 EMS dispatch network.",
    longDescription: "Features 9 challenging tasks, medically accurate survival curves, and a Pune-inspired 12-zone environment for modeling dispatch dynamics.",
    techStack: ["Python", "Machine Learning", "AI"],
    repo: "https://github.com/sameerdubey2507/emergi-env",
    demo: "#",
  ...
  {
    id: "studyplanner-os",
    title: "StudyPlanner OS",
    category: "Productivity",
    description: "A strategic engine for students helping break down complex syllabi.",
    longDescription: "Built with a focus on modularity and user experience, this planner helps users break down complex syllabi into actionable daily sprints.",
    techStack: ["TypeScript", "Next.js", "Tailwind CSS"],
    repo: "https://github.com/sameerdubey2507/studyplanner-os",
    demo: "#",
  ...
  },
  {
    ...
    description: "A robust Python-powered web application designed for network engineers.",
    longDescription: "This tool simplifies the complexities of IP networking by providing instant calculations for CIDR notation, usable IP ranges, and more.",
    techStack: ["HTML", "Python", "Flask"],
    repo: "https://github.com/sameerdubey2507/subnet-os",
    demo: "#",
  ...
  },
  {
    ...
    description: "An offline-first disaster management ecosystem.",
    longDescription: "Features a peer-to-peer mesh network, AI-driven hazard mapping, and tactical comms to coordinate rescues and family reunification when cellular infrastructure fails.",
    techStack: ["TypeScript", "Next.js", "AI", "Mesh Network"],
    repo: "https://github.com/sameerdubey2507/crisis-os",
    demo: "#",
