...
const TESTIMONIALS = [
  {
    quote: "Sameer delivered exceptional code on the project. His understanding of architecture is top-notch.",
    name: "Alex Morgan",
    role: "Project Manager",
    initials: "AM",
  },
  {
    quote: "The platform is blazing fast. Sameer's optimization skills significantly improved our conversion rates.",
    name: "Sarah Chen",
    role: "CTO",
    initials: "SC",
  },
